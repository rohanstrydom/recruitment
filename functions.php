...
include('functions/candidate_save_response_one.php');
include('functions/candidate_save_response_second.php');
include('functions/candidate_save_response_third.php');
...
add_action('wp_ajax_candidate_save_response_one', 'candidate_save_response_one');// for users who are logged in
add_action('wp_ajax_nopriv_candidate_save_response_one', 'candidate_save_response_one');//for users that are not logged in.

add_action('wp_ajax_candidate_save_response_two', 'candidate_save_response_two');// for users who are logged in
add_action('wp_ajax_nopriv_candidate_save_response_two', 'candidate_save_response_two');//for users that are not logged in.

add_action('wp_ajax_candidate_save_response_three', 'candidate_save_response_three');// for users who are logged in
add_action('wp_ajax_nopriv_candidate_save_response_three', 'candidate_save_response_three');//for users that are not logged in.
